...
public class CommentController
{
            ...
            CommentCreateForm data)
    {
        ...
        {
            return Response
                    .status(SystemValue.ERRORCODE_3005)
                    .entity(ErrorCodeUtil
                            .set_error_code(SystemValue.ERRORCODE_3005))
                    .build();
        }

        int comment_id = comment_service.createComment(data.set_comment_data(
                token.getUser(), post));

        if (comment_id == 0)
        {
            return Response
                    .status(SystemValue.ERRORCODE_4001)
                    .entity(ErrorCodeUtil
                            .set_error_code(SystemValue.ERRORCODE_4001))
                    .build();
        }
        ...
        return Response
                ...
                .entity(ErrorCodeUtil.set_code(SystemValue.CODE_200,
                        "comment create success", comment_id)).build();
    }
            ...
            CommentEditForm data)
    {
        ...
        {
            return Response
                    .status(SystemValue.ERRORCODE_4004)
                    .entity(ErrorCodeUtil
                            .set_error_code(SystemValue.ERRORCODE_4004))
                    .build();
        }
        ...
        {
            return Response
                    .status(SystemValue.ERRORCODE_4002)
                    .entity(ErrorCodeUtil
                            .set_error_code(SystemValue.ERRORCODE_4002))
                    .build();
        }
        ...
        return Response
                .status(SystemValue.CODE_200)
                .entity(ErrorCodeUtil.set_code(SystemValue.CODE_200,
                        "post update success", null)).build();
    }
            ...
            CommentEditForm data)
    {
        ...
        {
            return Response
                    .status(SystemValue.ERRORCODE_4003)
                    .entity(ErrorCodeUtil
                            .set_error_code(SystemValue.ERRORCODE_4003))
                    .build();
        }
        ...
        return Response
                .status(SystemValue.CODE_200)
                .entity(ErrorCodeUtil.set_code(SystemValue.CODE_200,
                        "post delete success", null)).build();
    }
        ...
        if (mode == SystemValue.COMMENT_GET_MODE_ID)
        {
            ...
            } else
            {
                resp = Response
                        .status(SystemValue.CODE_200)
                        .entity(ErrorCodeUtil.set_code(SystemValue.CODE_200,
                                "get comment by id", comment)).build();
        ...
        if (mode == SystemValue.COMMENT_GET_MODE_CURRENT)
        {
            ...
            } else
            {
                resp = Response
                        .status(SystemValue.CODE_200)
                        .entity(ErrorCodeUtil.set_code(SystemValue.CODE_200,
                                "get comment by current user", comment_service
                                        .getAllCommentByUserId(user.getId())))
                        .build();
            }
        }
        if (mode == SystemValue.COMMENT_GET_MODE_POSTID)
        {
            ...
            } else
            {
                resp = Response
                        .status(SystemValue.CODE_200)
                        .entity(ErrorCodeUtil.set_code(SystemValue.CODE_200,
                                "get comment by user id", comment_service
                                        .getAllCommentByPostId(post.getId())))
                        .build();
            }
        }
