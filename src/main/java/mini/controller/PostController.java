...
public class PostController
{
            ...
            PostCreateForm data)
    {
        ...
        int post_id = post_service.createPost(data.set_post_data(token
                .getUser()));

        if (post_id == 0)
        {
            return Response
                    .status(SystemValue.ERRORCODE_3001)
                    .entity(ErrorCodeUtil
                            .set_error_code(SystemValue.ERRORCODE_3001))
                    .build();
        }
        ...
        return Response
                ...
                .entity(ErrorCodeUtil.set_code(SystemValue.CODE_200,
                        "post create success", post_id)).build();
    }
            ...
            PostEditForm data)
    {
        ...
        {
            return Response
                    .status(SystemValue.ERRORCODE_3003)
                    .entity(ErrorCodeUtil
                            .set_error_code(SystemValue.ERRORCODE_3003))
                    .build();
        }
            ...
            PostEditForm data)
    {
        ...
        {
            return Response
                    .status(SystemValue.ERRORCODE_3002)
                    .entity(ErrorCodeUtil
                            .set_error_code(SystemValue.ERRORCODE_3002))
                    .build();
        }
            ...
            PostEditForm data)
    {
        ...
        {
            return Response
                    .status(SystemValue.ERRORCODE_3004)
                    .entity(ErrorCodeUtil
                            .set_error_code(SystemValue.ERRORCODE_3004))
                    .build();
        }
    ...
    public Response getPost(
            ...
            @QueryParam ( "limit" )
            int limit,
            @Pattern ( regexp = SystemValue.POST_TITLE_SEARCH_RANGE )
            ...
            String keysearch)
    {
        ...
        Response resp = Response
                .status(SystemValue.CODE_200)
                .entity(ErrorCodeUtil.set_code(SystemValue.CODE_200, "invalid",
                        null)).build();
        if (mode == SystemValue.POST_GET_MODE_ALL)
        {
            resp = Response
                    .status(SystemValue.CODE_200)
                    .entity(ErrorCodeUtil.set_code(SystemValue.CODE_200,
                            "Get all post", post_service.getAllPost())).build();
        }
        ...
        if (mode == SystemValue.POST_GET_MODE_TOP)
        {
            ...
            resp = Response
                    .status(SystemValue.CODE_200)
                    .entity(ErrorCodeUtil.set_code(SystemValue.CODE_200,
                            "top post", post_service.getTopPost(limit)))
                    .build();
        }
