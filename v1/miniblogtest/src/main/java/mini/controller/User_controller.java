...
public class User_controller {
    ...
    public Response User_Login(
		...
		final String access_token_key=user_service.Login_user(data);
		...
		return Response.status(System_value.code_200)
				.entity(error_code_util.set_code(200, "Login successful!", null, obj))
				.build();
    }
    ...
    public Response User_Logout(
    	...
    	return Response.status(System_value.code_200)
    			.entity(error_code_util.set_code(200, "Logout successful!", null,null ))
    			.build();
    }
